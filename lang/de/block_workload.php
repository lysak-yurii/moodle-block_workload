...
$string['anonymizeteacherstats']      = 'Statistiken für Lehrende anonymisieren';
$string['anonymizeteacherstats_desc'] = 'Zeigt in den Kursstatistiken, die Lehrende ansehen und exportieren (Einschreibungsmodus), stabile Pseudonyme statt echter Namen, E-Mail-Adressen, Abteilungen und Institutionen, sofern die betrachtende Person nicht die Fähigkeit „Echte Identitäten sehen" (block/workload:viewrealnames) besitzt. Website-Administrator/innen sehen immer echte Namen. Standard: aktiviert.';
...
$string['exportdetailedcourseanon_desc'] = 'Eine Zeile pro Studierenden pro Woche: Pseudonym und die in diesem Kurs erfassten Wochenstunden. Ihre eigenen Einträge und die anderer Kurs-Lehrender erscheinen mit echten Namen und stehen an erster Stelle.';
...
$string['exportquickcourseanon_desc'] = 'Eine Zeile pro Studierenden: Pseudonym, Gesamtstunden, aktive Wochen, Durchschnitt. Identifizierende Spalten bleiben leer. Ihre eigenen Einträge und die anderer Kurs-Lehrender erscheinen mit echten Namen und stehen an erster Stelle.';
