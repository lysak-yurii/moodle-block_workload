...
$string['defaulttargethours_desc'] = 'Siteweiter Standard für die Zielstunden eines Kurses (Gesamtzeit, die ein Kurs voraussichtlich erfordert). Gilt für jeden Kurs ohne eigenen Zielwert. 0 bedeutet kein Standard: Kurse ohne eigenen Zielwert zeigen keinen Fortschrittsbalken.';
$string['defaulttargetinfo']    = 'Globaler Standard: {$a} h — wird in der Website-Administration geändert.';
$string['defaulttargetnone']    = 'Kein globaler Standard gesetzt — Kurse ohne eigenen Zielwert zeigen keinen Fortschrittsbalken.';
...
$string['effectivetarget']      = 'Wirksamer Zielwert';
...
$string['enablecoursewidget_desc'] = 'Fügt den Workload-Block zu jedem Kurs hinzu, wo Studierende ihre Stunden für diesen Kurs erfassen und ihren Fortschritt gegenüber den Zielstunden sehen. Beim Aktivieren wird der Block automatisch in allen Kursen platziert; beim Deaktivieren wieder entfernt. Wenn deaktiviert, ist der Block nur auf dem Dashboard verfügbar und Kursziele werden Studierenden nicht angezeigt. Selbst hinzugefügte Blöcke in einzelnen Kursen bleiben unverändert. Hinweis: Wenn eine Administratorin oder ein Administrator den Block innerhalb eines Kurses löscht, wird er aus allen Kursen entfernt; deaktivieren und reaktivieren Sie diese Einstellung, um ihn wiederherzustellen.';
...
$string['exportcourselist_desc'] = 'Laden Sie die Kursliste mit den aktuellen Zielstunden herunter. Füllen oder ändern Sie die Spalte target_hours und laden Sie die Datei unten hoch — leer oder 0 entfernt den eigenen Zielwert eines Kurses.';
...
$string['importcolnew']         = 'Neuer Zielwert (h)';
$string['importcolold']         = 'Aktueller Zielwert (h)';
...
$string['importnochanges']      = 'Nichts anzuwenden — keine Zeile würde einen Zielwert erstellen, ändern oder entfernen.';
...
$string['privacy:metadata:block_workload_targets:createdby']  = 'Die ID des Managers, der den Zielwert festgelegt hat.';
...
$string['targethours_invalid']     = 'Bitte eine Zahl größer oder gleich 0 eingeben.';
$string['targethourslabel']     = 'Zielstunden';
$string['targetplaceholder']    = 'z. B. 150';
$string['targetsdisabledbanner'] = 'Das Kurs-Widget ist derzeit vom Website-Administrator deaktiviert. Sie können hier Zielstunden vorbereiten, sie werden Studierenden jedoch erst nach Reaktivierung der Funktion angezeigt (Website-Administration → Plugins → Blöcke → Workload).';
$string['targetsource_course']  = 'Kurs';
$string['targetsource_default'] = 'Standard';
$string['targetsource_none']    = 'Kein Zielwert';
