...
$string['anonymizestats']      = 'Анонімізувати статистику';
$string['anonymizestats_desc'] = 'Показувати стабільні псевдоніми замість справжніх імен, електронних адрес, відділів та закладів у статистиці навантаження та експортах для користувачів, які не мають права «Бачити справжні імена» (block/workload:viewrealnames). Адміністратори сайту завжди бачать справжні імена.';
$string['anonymizeteacherstats']      = 'Анонімізувати статистику для викладачів';
$string['anonymizeteacherstats_desc'] = 'Показувати стабільні псевдоніми замість справжніх імен, електронних адрес, відділів та закладів у статистиці курсів, яку переглядають та експортують викладачі (режим зарахування), якщо користувач не має права «Бачити справжні імена» (block/workload:viewrealnames). Адміністратори сайту завжди бачать справжні імена. Типово: увімкнено.';
