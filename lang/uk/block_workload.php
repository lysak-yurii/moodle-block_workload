...
$string['defaulttargethours_desc'] = 'Загальносайтовий стандарт цільових годин курсу (загальний час, який має зайняти курс). Застосовується до кожного курсу без власного цільового значення. 0 означає відсутність стандарту: курси без власної цілі не показують індикатор прогресу.';
$string['defaulttargetinfo']    = 'Глобальний стандарт: {$a} год — змінюється в адмініструванні сайту.';
$string['defaulttargetnone']    = 'Глобальний стандарт не встановлено — курси без власної цілі не показують індикатор прогресу.';
...
$string['effectivetarget']      = 'Чинна ціль';
...
$string['enablecoursewidget_desc'] = 'Додає блок Workload до кожного курсу, де студенти фіксують години для цього курсу та бачать свій прогрес відносно цільових годин. Увімкнення автоматично розміщує блок в усіх курсах; вимкнення видаляє його. Якщо вимкнено, блок доступний лише на панелі керування, а цілі курсів студентам не показуються. Блоки, додані вами вручну в окремих курсах, не змінюються. Зверніть увагу: якщо адміністратор видалить блок усередині курсу, його буде видалено з усіх курсів; зніміть і знову встановіть цей прапорець, щоб відновити його.';
...
$string['exportcourselist_desc'] = 'Завантажте список курсів із поточними цільовими годинами. Заповніть або змініть колонку target_hours і завантажте файл нижче — порожнє значення або 0 видаляє власну ціль курсу.';
...
$string['importcolnew']         = 'Нова ціль (год)';
$string['importcolold']         = 'Поточна ціль (год)';
...
$string['importnochanges']      = 'Немає чого застосовувати — жоден рядок не створює, не змінює та не видаляє ціль.';
...
$string['privacy:metadata:block_workload_targets:createdby']  = 'ID менеджера, який встановив цільове значення.';
...
$string['targetsdisabledbanner'] = 'Віджет у курсі наразі вимкнено адміністратором сайту. Ви можете підготувати цільові години тут, але студенти не побачать їх, доки функцію не буде знову увімкнено (Адміністрування сайту → Плагіни → Блоки → Workload).';
$string['targetsource_course']  = 'курс';
$string['targetsource_default'] = 'стандарт';
$string['targetsource_none']    = 'Без цілі';
