...
$string['enablecoursewidget_desc'] = 'Якщо увімкнено, блок Workload може відображатися на сторінках курсів, де студенти фіксують години для цього курсу та бачать свій прогрес відносно цільових годин курсу. Якщо вимкнено, блок доступний лише на панелі керування, а цілі курсів студентам не показуються.';
