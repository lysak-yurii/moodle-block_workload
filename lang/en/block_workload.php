...
$string['anonymizestats']      = 'Anonymise statistics';
$string['anonymizestats_desc'] = 'Show stable pseudonyms instead of real names, emails, departments and institutions in workload statistics and exports for viewers who do not hold the "See real user identities" capability (block/workload:viewrealnames). Site administrators always see real names.';
$string['anonymizeteacherstats']      = 'Anonymise teacher statistics';
$string['anonymizeteacherstats_desc'] = 'Show stable pseudonyms instead of real names, emails, departments and institutions in the course statistics that teachers view and export (Enrollment mode), unless the viewer holds the "See real user identities" capability (block/workload:viewrealnames). Site administrators always see real names. Default: enabled.';
