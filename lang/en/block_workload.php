...
$string['blocktitle_teacher'] = 'Student Workload';
...
$string['coursetargets']        = 'Course target hours';
$string['courseunhiddenglobally'] = 'Course is no longer hidden globally.';
$string['courseupdated']        = 'Course settings updated.';
$string['coursewidget_teacher_tooltip'] = 'Overview of the hours the students of this course recorded.';
$string['coursewidget_tooltip']     = 'Log the hours you spent on this course this week.';
$string['coursewidget_tooltip_nav'] = 'Log the hours you spent on this course. Use the arrows to record earlier weeks.';
...
$string['defaulttargethours']      = 'Default target hours';
$string['defaulttargethours_desc'] = 'Site-wide default for a course\'s target hours (the total time a course is expected to take). Applies to every course without its own target hours. 0 means no default: courses without their own target hours show no progress bar.';
$string['defaulttargetinfo']    = 'Default target hours: {$a} h — change this in site administration.';
$string['defaulttargetnone']    = 'No default target hours set — courses without their own target hours show no progress bar.';
...
$string['effectivetarget']      = 'Effective target hours';
...
$string['enablecoursewidget']      = 'Enable in-course widget';
$string['enablecoursewidget_desc'] = 'Adds the Workload block to every course, where students log hours for that course and see their progress against its target hours. Ticking this places the block in all courses automatically; unticking removes it again. When off, the block is available on the dashboard only and course target hours are not shown to students. Note that if an administrator deletes the block from inside a course, it is removed from all courses; untick and retick this setting to restore it.';
...
$string['event_course_target_updated']    = 'Course target hours updated';
$string['event_course_targets_imported']  = 'Course target hours imported';
...
$string['exportcourselist']      = 'Export course list';
$string['exportcourselist_desc'] = 'Download the course list with the current target hours pre-filled. Fill in or change the target_hours column and upload the file below — blank or 0 clears a course\'s own target hours.';
...
$string['exportxlsx']            = 'Export as Excel (.xlsx)';
...
$string['importapplied']        = 'Import applied: {$a->created} created, {$a->updated} updated, {$a->cleared} cleared.';
$string['importcolidentifier']  = 'Identifier';
$string['importcolnew']         = 'New target hours';
$string['importcolold']         = 'Current target hours';
$string['importconfirm']        = 'Apply changes';
$string['importfile']           = 'File (.csv or .xlsx)';
$string['importfrommoodlecohort']      = 'Import from Moodle System Cohorts';
$string['importmissingcolumns'] = 'The file must contain a target_hours column and at least one of: course_id, shortname, idnumber.';
$string['importnochanges']      = 'Nothing to apply — no row would create, change or clear target hours.';
$string['importnorows']         = 'No data rows found in the file.';
$string['importpreviewheading'] = 'Import preview';
$string['importselected']              = 'Import selected';
$string['importstatus_changed']   = 'Changed';
$string['importstatus_cleared']   = 'Cleared';
$string['importstatus_invalid']   = 'Invalid value';
$string['importstatus_new']       = 'New';
$string['importstatus_unchanged'] = 'Unchanged';
$string['importstatus_unmatched'] = 'Course not found';
$string['importsummary']        = '{$a->new} new, {$a->changed} changed, {$a->unchanged} unchanged, {$a->cleared} cleared, {$a->unmatched} unmatched, {$a->invalid} invalid';
$string['importtargets']        = 'Import target hours';
$string['importtargets_desc']   = 'Upload a completed course list (.csv or .xlsx). You will see a preview of all changes before anything is saved.';
...
$string['notargetcourses']      = 'No courses found.';
...
$string['privacy:metadata:block_workload_targets']            = 'Per-course target hours configured by managers.';
$string['privacy:metadata:block_workload_targets:createdby']  = 'The ID of the manager who set the target hours.';
...
$string['progresslabel']            = 'Course progress';
...
$string['targethours_invalid']     = 'Please enter a number greater than or equal to 0.';
$string['targethourslabel']     = 'Target hours';
$string['targetplaceholder']    = 'e.g. 150';
$string['targetsdisabledbanner'] = 'The in-course widget is currently disabled by the site administrator. You can prepare target hours here, but they are not shown to students until the feature is re-enabled.';
$string['targetsource_course']  = 'course';
$string['targetsource_default'] = 'default';
$string['targetsource_none']    = 'No target hours';
$string['thisweeklabel']            = 'This week';
...
$string['uploadandpreview']     = 'Upload and preview';
