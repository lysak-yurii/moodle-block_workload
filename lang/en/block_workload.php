...
$string['enablecoursewidget_desc'] = 'When enabled, the Workload block can be shown on course pages, where students log hours for that course and see their progress against the course\'s target hours. When disabled, the block is available on the dashboard only and course targets are not shown to students.';
