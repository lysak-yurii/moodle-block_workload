...
$string['defaulttargethours_desc'] = 'Site-wide default for a course\'s target hours (the total time a course is expected to take). Applies to every course without its own target. 0 means no default: courses without their own target show no progress bar.';
$string['defaulttargetinfo']    = 'Global default: {$a} h — changed in site administration.';
$string['defaulttargetnone']    = 'No global default set — courses without their own target show no progress bar.';
...
$string['effectivetarget']      = 'Effective target';
...
$string['event_course_target_updated']    = 'Course workload target updated';
$string['event_course_targets_imported']  = 'Course workload targets imported';
...
$string['exportcourselist_desc'] = 'Download the course list with the current target hours pre-filled. Fill in or change the target_hours column and upload the file below — blank or 0 clears a course\'s own target.';
...
$string['importcolnew']         = 'New target (h)';
$string['importcolold']         = 'Current target (h)';
...
$string['importnochanges']      = 'Nothing to apply — no row would create, change or clear a target.';
...
$string['privacy:metadata:block_workload_targets']            = 'Per-course workload target hours configured by managers.';
$string['privacy:metadata:block_workload_targets:createdby']  = 'The ID of the manager who set the target.';
...
$string['targetsdisabledbanner'] = 'The in-course widget is currently disabled by the site administrator. You can prepare target hours here, but they are not shown to students until the feature is re-enabled (Site administration → Plugins → Blocks → Workload).';
$string['targetsource_course']  = 'course';
$string['targetsource_default'] = 'default';
$string['targetsource_none']    = 'No target';
